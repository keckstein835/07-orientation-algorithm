...
plot_multislice_XY(imageStack_downsampled, V_downsampled, FA_downsampled, round(slice/2), 1)
...
plot_multislice_XY(imageStack_downsampled, V_downsampled_smooth, FA_downsampled, round(slice/2), 1)
...
function plot_multislice_XY(imageStack, V_orientation_all_interp, FA_all, slice, vox_orientation_spacing)
